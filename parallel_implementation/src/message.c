...
void getCharFreqDicFromMsgDict(CharFreqDictionary* dict, MsgDictionary* msgDict) {
	...
	// // maybe we could use memcpy here
	// for (int i = 0; i < msgDict->charsNr; i++) {
...
void getMsgDictFromByteBuffer(MsgDictionary* msgRcv, BYTE *buffer){
