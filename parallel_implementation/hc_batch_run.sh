...
do 
    ...
    do
        ...
        do
            ...
            qsub -q short_cpuQ -l select=$i:ncpus=$i -v "num_of_threads=$t" -o parallel_implementation/output/out -e parallel_implementation/output/err ./parallel_implementation/hc_batch_qsub.sh
