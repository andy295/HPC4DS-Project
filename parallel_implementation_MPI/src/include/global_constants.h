...
#define ENCODED_FILE "HPC4DS-Project/new_parallel_implementation/output/encoded_file"
#define SRC_FILE "HPC4DS-Project/new_parallel_implementation/text.txt"
#define TIME_LOG_FILE "HPC4DS-Project/new_parallel_implementation/output/data.csv"
#define DATA_LOGGER_FILE "HPC4DS-Project/new_parallel_implementation/output/data_log.csv"
